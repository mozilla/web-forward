...
<div class="row padding-small" id="aboutMain">
	<div class="four columns">
		...
		<div id="light" class="white_content"><iframe src="http://player.vimeo.com/video/52167567?badge=0&amp;autoplay=1" width="500" height="281" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe> <p><a href = "javascript:void(0)" onclick = "document.getElementById('light').style.display='none';document.getElementById('fade').style.display='none'" class="medium blue radius button">Close</a></p></div>
