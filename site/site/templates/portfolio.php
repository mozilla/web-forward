		...
		<?php foreach($files->images() as $image): ?>
			<li>
				<div class="alumni">
					...
					<h6><a href="<?php echo $image->link() ?>" target="_blank">Visit <?php echo $image->name() ?></a><?php (isset($image->$video) : ?> | <a href="<?php echo $image->video() ?>" target="_blank">Video</a><?php endif; ?></h6>
				</div>
			</li>
		<?php endforeach ?>
		</ul>
