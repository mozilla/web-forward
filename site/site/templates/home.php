...
<section class="container" id="home">
  ...
  <section class="row text-center col-3-info">
    <div class="col-xs-12 col-md-4">
      <center>
        <img src="assets/images/promo-a.png" alt="Startup image" class="img-responsive">
      <center>
      <h4>If you are a startup program</h4>
