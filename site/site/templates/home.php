...
<div class="row padding" style="background-color: rgba(250,250,250,0.5); padding-bottom: 48px;">
	<div class="four columns">
		<h1 style="padding-left: 48px; line-height: 1.2;"> 

		<h3> We are currently making some exciting changes for WebFWD. <a href="http://blog.webfwd.org/post/68820630391/moving-the-web-even-more-forward" title="Here" target="_blank"> is a sneak peak of what is coming. Continue following our blog for future updates.  </h3>
	</div>	
</div>
