...
<div class="row padding-small">
	<div class="ten columns centered">
		<video id="webfwd-about-video" class="video-js vjs-default-skin" controls preload="none" data-setup="{}" poster="../../accelerator/assets/images/webfwd_2012.jpg">
...
<div class="row padding-small">
	<div class="ten columns centered">
		<div id="featured">
			<img src="../../accelerator/assets/images/about-program.jpg" alt="WebFWD Program" data-caption="#htmlCaption1" />
			<img src="../../accelerator/assets/images/about-experts.jpg" alt="WebFWD Experts" data-caption="#htmlCaption2" />
			<img src="../../accelerator/assets/images/about-team.jpg" alt="WebFWD Team" data-caption="#htmlCaption3" />
			<img src="../../accelerator/assets/images/about-partners.jpg" alt="WebFWD Partners" data-caption="#htmlCaption4" />
		</div>
...
<div class="row padding-small" id="aboutMain">
	<div class="four columns">
		...
		<a href="/accelerator/apply/" class="medium blue radius button">Apply For Our Next Class</a>
	</div>
	<div class="eight columns">
		<ul class="block-grid two-up">
			...
			<li>
				<h3><a href="<?php echo url($page->slug4()) ?>"><?php echo $page->header3() ?> »</a></h3>
